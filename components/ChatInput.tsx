  ...
  return (
    <div className="relative">
      <Textarea
        ...
        disabled={isLoading}
        className="min-h-[60px] pr-16 resize-none border focus:border-primary transition-colors"
        maxLength={2000}
      />
      <Button
        onClick={onSubmit}
        ...
        size="sm"
        className="absolute bottom-[20px] right-3 h-12 w-12 p-0 flex items-center justify-center"
      >
